          ...
          <div className={styles.infoSection}>
            ...
            <div className={styles.inputGroup}>
              ...
              <div className={styles.inputRow}>
                <input type="text" className={styles.input} placeholder="Producto físico" disabled />
            ...
            <div className={styles.inputGroup}>
              ...
              <textarea className={styles.textarea} placeholder="Descripción del producto"></textarea>
            </div>
        ...
        <div className={styles.rightColumn}>
          <div className={styles.unitSection}>
            ...
            <div className={styles.inputRow}>
              ...
              <input type="text" className={styles.input} placeholder="Costo por unidad y proveedor" />
            </div>
            <div className={styles.inputRow}>
